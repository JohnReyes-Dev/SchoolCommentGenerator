...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        List<string> firstSentenceList = new List<string>
            {
                " has a great attitude and a great personality and makes a tremendous effort.",
                ...
                " is a great child and always comes to lesson on time and with homework completed.",
                ...
                " is a smart student and tries to know the right answer.",
        ...
        List<string> secondSentenceList = new List<string>
            {
                ...
                " follows most the class instructions well and doesn't get distracted easily.",
                " is not afraid to speak up in class and tries to get along well with the other students.",
                " is an enthusiastic member of the class who tries enjoys all aspects of the work.",
        ...
        List<string> thirdSentenceList = new List<string>
            {
                ...
                " has shown a thorough grasp of the topics we have been studying.",
                " has proven to have a thorough understanding of the topics we have been studying.",
                ...
                " enjoys participating in conversation and discussion.",
                " is willing to take part in all classroom activities.",
                " shows initiative and thinks things through before responding.",
        ...
        List<string> forthSentenceList = new List<string>
            {
                ...
                " will do well in furutre English classes.",
